<template>
  ...
  <div class="app-container ohn">
    ...
    <el-dialog :visible.sync="add_dialogVisible" :title="add_dialogType==='new'?'添加客户合同':'编辑客户合同'">
      <el-form ref="add_creditInfo" :model="add_creditInfo" status-icon :rules="auditRules" label-width="140px"
               label-position="left">
        <el-form-item label="客户名称：" prop="clientName">
          <el-select value-key="id" v-model="add_creditInfo.clientName" filterable placeholder="请输入后选择"
                     @change="changeSelectName" style="width: 240px">
            <el-option
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='new'?'查看客户合同':'审核客户合同'">
      <el-form ref="creditInfo" :model="creditInfo" :rules="reviewReasonRules" label-width="140px"
               label-position="left">
        ...
        <el-form-item v-if="dialogType==='edit'" label="原因：" prop="reviewReason"
  ...
  export default {
    ...
    methods: {
      ...
      handleSearchTestTradeList() {
        ...
        let columnParam = deepClone(this.columnParam)
