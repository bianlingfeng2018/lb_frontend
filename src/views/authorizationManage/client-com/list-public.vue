        ...
        <template slot-scope="scope">
          ...
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="handleLock(scope.row)">锁定</el-dropdown-item>
...
import { deleteClientCom, lockClient, queryClientComPagePub } from "@/api/clientCompany"
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      queryClientComPagePub(Object.assign({}, queryParam, colParam))
        .then((res) => {
    ...
    onExport() {
      ...
      const fileName = 'export-pub.xlsx'
      const url = "/api/cli-pub-export"
