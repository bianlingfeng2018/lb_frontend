    ...
    <footer class="footer">
      ...
      <div class="service-intro">
        <div class="servece-type">
          <div v-for="(guide, index) in guideArr" :key="index" class="servece-type-info">
            <ul>
        ...
        <div class="clearfix" />
        <div class="copyright">
          <p>Copyright © 2018 by Gavin
            <a href="https://github.com/PowerDos">
...
.footer-icon-child {
  ...
  width: 36px;
  height: 42px;
  background-image: url("../../../assets/static/img/footer/ico_service.png");
  text-indent: -999px;
}
.footer-icon-child-2 {
